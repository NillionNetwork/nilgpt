          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white border-4 border-navy-900 brutalist-shadow p-8 space-y-8">
              ...
              <section>
                ...
                <p className="text-navy-700 leading-relaxed mb-4">
                  i) submit prompts or inputs, including uploading images, pdf,
                  csv or other documents for processing by one or more LLMs;
                </p>
                <p className="text-navy-700 leading-relaxed mb-4">
              ...
              <section>
                ...
                <p className="text-navy-700 leading-relaxed mb-4">
                  nilGPT provides a Websearch feature that is facilitated
                  through the Brave Search API ("Brave"). By enabling Websearch,
                  you authorize Nillion to transmit your search queries to Brave
                  for processing and retrieval of search results. Prior to
                  transmission, Nillion may summarize, rephrase, or otherwise
                  transform your queries in order to optimize performance and
                  relevance of search results. Brave may receive, process, and
                  store your queries (in their summarized or reformulated form).
                  You must not use Websearch to submit queries that contain
                  personal, confidential, or sensitive information (including,
                  without limitation, financial data, health information, or
                  identifiers such as names, addresses, or account numbers).
                </p>
                <p className="text-navy-700 leading-relaxed mb-4">
                  Nillion has no control over Brave's processing of such queries
                  and disclaims all liability arising from Brave's use,
                  retention, or disclosure of such data. By enabling Websearch,
                  you acknowledge and agree that;
                </p>
                <ul className="list-disc list-inside text-navy-700 space-y-2 mb-4">
                  <li>your queries may be visible to Brave</li>
                  <li>
                    Brave's processing of your queries is subject exclusively to
                    Brave's own terms of service and privacy policy and
                  </li>
                  <li>
                    Nillion shall not be responsible for Brave's acts or
                    omissions.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-navy-700 leading-relaxed">
                  ...
                  <a href="/privacy-policy" className="text-navy-900 underline">
                    /privacy-policy
                  </a>
                  .
                </p>
